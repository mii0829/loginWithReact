...
const authSlice = createSlice({
  ...
  //redux toolkitのextraReducersメソッドを使用。
  //reduxtoolkitは、reduxアプリケーションを簡略化するためのライブラリ
  //それぞれのaction(register, login, logout)に対する状態変化を管理
  extraReducers: (builder) => {
    builder
      // Register User
      .addCase(register.pending, (state) => {
        //registeractionが処理中の場合はisloadingフラグをtrueに設定。ローディングマーク
